...
>(
	...
	oldSchema: OldSchema,
	newSchema: NewSchema
): z.ZodType<ReplaceDeep<z.infer<Schema>, z.infer<OldSchema>, z.infer<NewSchema>>> {
...
const CountryCodeProxy = z.literal('ZZ')

const reps = new Map([[CountryCode, CountryCodeProxy]])
...
const newUser = deepReplace(userSchema, z.object({ code: CountryCode }), CountryCodeProxy)
